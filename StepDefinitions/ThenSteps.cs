...
public class ThenSteps(ScenarioContext scenarioContext)
{
    ...
    public static void ThenNewUserSignupShouldBeVisible() => Assert.True(SignupLoginPage.IsNewUserSignupVisible());

    [Then("Enter Account Information should be visible")]
    public static void ThenEnterAccountInformationShouldBeVisible() => Assert.True(AccountInfoPage.IsEnterAccountInfoVisible());
    ...
    public static void ThenLoginToYourAccountShouldBeVisible() => Assert.True(SignupLoginPage.IsLoginHeaderVisible());

    [Then(@"""(.*)"" text should be visible")]
    public static void ThenTextShouldBeVisible(string expectedText)
    {
